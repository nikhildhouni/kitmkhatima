    ...
    class Education_X_Author_Post_widget extends Education_X_Widget_Base
    {
        ...
        function __construct()
        {
            $opts = array(
                ...
                'description' => __('Displays message details in post.', 'education-x-pro'),
                'customize_selective_refresh' => true,
            );
            $fields = array(
                'title' => array(
                    'label' => __('Title:', 'education-x-pro'),
                    'type' => 'text',
                    'class' => 'widefat',
                ),
                'author-name' => array(
                    'label' => __('Name:', 'education-x-pro'),
                    'type' => 'text',
                    'class' => 'widefat',
                ),
                'discription' => array(
                    'label' => __('Discription:', 'education-x-pro'),
                    'type' => 'text',
                    'class' => 'widget-content widefat'
                ),
                'image_url' => array(
                    'label' => __('Image:', 'education-x-pro'),
                    'type' => 'image',
                ),
                'signature_image_url' => array(
                    'label' => __('Signature Image:', 'education-x-pro'),
                    'type' => 'image',
                ),
                'url-fb' => array(
                    'label' => __('Facebook URL:', 'education-x-pro'),
                    'type' => 'url',
                    'class' => 'widefat',
                ),
                'url-tw' => array(
                    'label' => __('Twitter URL:', 'education-x-pro'),
                    'type' => 'url',
                    'class' => 'widefat',
                ),
                'url-insta' => array(
                    'label' => __('Instagram URL:', 'education-x-pro'),
                    'type' => 'url',
                    'class' => 'widefat',
                ),
            );

            parent::__construct('education-x-author-layout', __('BE: Message Widget', 'education-x-pro'), $opts, array(), $fields);
        }
    ...
    class Education_X_widget_social extends Education_X_Widget_Base
    {
        ...
        function __construct()
        {
            $opts = array(
                ...
                'description' => __('Displays social menu if you have set it(social menu)', 'education-x-pro'),
                'customize_selective_refresh' => true,
            );
            $fields = array(
                'title' => array(
                    'label' => __('Title:', 'education-x-pro'),
                    'description' => __('Note: Displays social menu if you have set it(social menu)', 'education-x-pro'),
                    'type' => 'text',
                    'class' => 'widefat',
                ),
                'description' => array(
                    'label' => __('Description:', 'education-x-pro'),
                    'type' => 'text',
                    'class' => 'widefat',
                ),
            );
            parent::__construct('education-x-social-layout', __('BE: Social Menu Widget', 'education-x-pro'), $opts, array(), $fields);
        }
        ...
        function widget($args, $instance)
        {
            ...
            <p>
                <?php esc_html_e( 'Social menu is not set. You need to create menu and assign it to Social Menu on Menu Settings.', 'education-x-pro' ); ?>
            </p>
            <?php endif; ?>
            <?php echo $args['after_widget'];
        }
