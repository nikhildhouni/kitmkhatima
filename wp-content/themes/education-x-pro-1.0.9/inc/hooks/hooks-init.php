...
require get_template_directory().'/inc/hooks/affiliation.php';
require get_template_directory().'/inc/hooks/browse-course.php';
require get_template_directory().'/inc/hooks/map-section.php';
