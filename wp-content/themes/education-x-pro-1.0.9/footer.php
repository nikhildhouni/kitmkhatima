...
<?php
// Popup Model Box
education_x_popup_model_box();

// Footer Mailchimp
education_x_footer_mailchimp();
                ...
                <div class="col-sm-12 col-xs-12">
                    <div class="site-copyright">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <?php if ((education_x_get_option('enable_copyright_credit')) == 1) { ?>
                                <div class="pull-right">
                                    <?php printf(esc_html__('Theme: %1$s by %2$s', 'education-x-pro'), '<a href="https://www.thememattic.com/theme/education-x-pro/" target = "_blank" >Education X Pro </a>', '<a href="https://thememattic.com" target = "_blank" rel="designer">Themematic </a>'); ?>
                                </div>
                            <?php } ?>
                            </div>
                        </div>
                            ...
                            <div class="cta-btn-group" role="group" aria-label="buttons">
                                <?php if ($education_x_footer_fix_button_enable == 1) { ?>
                                    <a href="<?php the_permalink(); ?>"
                                       class="btn btn-sm btn-primary tm-shadow"><?php _e('View More', 'education-x-pro'); ?></a>
                                <?php } ?>
