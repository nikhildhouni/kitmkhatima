...
<article id="post-<?php the_ID(); ?>" <?php post_class($post_image_class); ?>>
    <?php if (!is_single()) { ?>
        <?php $archive_layout = education_x_get_option('archive_layout'); ?>
        <?php $archive_layout_image = education_x_get_option('archive_layout_image'); ?>
            ...
            <div class="entry-content tm-entry-content <?php echo esc_attr($full_width_content); ?>">
                ...
                <?php if ('full' == $archive_layout) : ?>
                    ...
                    /* translators: %s: Name of current post. */
                        wp_kses(__('Continue reading %s <span class="meta-nav">&rarr;</span>', 'education-x-pro'), array('span' => array('class' => array()))),
